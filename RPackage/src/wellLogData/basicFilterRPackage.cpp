...
SEXP basicFilter(SEXP data_sexp, SEXP mu_sexp, SEXP sigma_sexp, SEXP nu_sexp, SEXP tau1_sexp, SEXP tau2_sexp, SEXP changeProbability_sexp, SEXP outlierProbability_sexp, SEXP outlierClusterProbability_sexp, SEXP nParticles_sexp, SEXP seed_sexp)
{
BEGIN_RCPP
	...
	wellLogData::basicFilterArgs methodArgs(randomSource);
	methodArgs.nParticles = nParticles;
	basicFilter(contextObj, methodArgs);
